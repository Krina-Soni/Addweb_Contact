...
import java.io.IOException;
    ...
    public class Contact extends BaseCase {
        ...
        @Test
        public static void sendSimpleMessage() throws UnirestException, InterruptedException, IOException {
            logger = extent.createTest("Check weather mailgun is able to send email or not");
            ContactUs very = new ContactUs(driver, logger);
            very.Validation();
        }
        }
